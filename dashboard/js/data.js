// ═══ SWIFT ANALYTICS — Dados Reais v4 (NPS Ajustado com Penalização) ═══
// Base: 116,605 comentários | 227 lojas | 4 UFs | Período: 2025-01 a 2026-05
// Fórmula: Promotor+TextoNeg→Detrator | Detrator+TextoPos→Neutro | Neutro±→Reclassifica
...
const DATA = {
    ...
    "regioes": [
      {
        "nome": "Capital",
        "tipo": "negative",
        "stat": "NPS Ajust: 55.4 | 71% pos | 14% neg"
      },
      {
        "nome": "DF",
        "tipo": "positive",
        "stat": "NPS Ajust: 59.1 | 72% pos | 11% neg"
      },
      {
        "nome": "GO",
        "tipo": "negative",
        "stat": "NPS Ajust: 53.6 | 72% pos | 17% neg"
      },
      {
        "nome": "Interior",
        "tipo": "positive",
        "stat": "NPS Ajust: 62.6 | 75% pos | 11% neg"
      },
      {
        "nome": "Litoral",
        "tipo": "positive",
        "stat": "NPS Ajust: 65.8 | 77% pos | 10% neg"
      },
      {
        "nome": "RJ",
        "tipo": "positive",
        "stat": "NPS Ajust: 60.2 | 73% pos | 11% neg"
      },
      {
        "nome": "RMSP",
        "tipo": "positive",
        "stat": "NPS Ajust: 61.3 | 75% pos | 12% neg"
      }
    ],
  ...
  "impacto_nps": {
    ...
    "lojas_mudaram_faixa": 52,
    "total_lojas": 227,
    "formula": "Penalização/Bonificação: Promotor+TextoNeg→Detrator | Detrator+TextoPos→Neutro | Neutro+TextoPos→Promotor | Neutro+TextoNeg→Detrator",
    "casos_extremos": [
      {
    ...
    "analise_critica": "O NPS ajustado captura insatisfação oculta: 2.674 promotores (nota 9-10) escreveram reclamações no texto. O ajuste pode ser excessivo em comentários irônicos ou mistos, mas revela tendências reais de descontentamento que a nota isolada mascara."
  },
  "lojas": [
    {
